# -*- coding: utf-8 -*-
"""
规则0918B 筛选 —— 20cm（科创板 688 + 创业板 300/301）
...
时间线（D-0 为基准日 i，向前回看历史）：
  ...
  D-0 (i)   : 非涨停；K 线为阴（收盘 ≤ 开盘）—— 基准日（无成交额/股价最高条件）

形态：D-1 放量封板（成交额最大、股价最高），D-2~D-6 连续缩量非涨停，D-0 未涨停收阴线（基准日）。
...
RULE_NAME = "0918B"
OUTPUT_DIR = Path(r"D:\09work\0918B_backtest")
