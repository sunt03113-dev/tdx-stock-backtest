# -*- coding: utf-8 -*-
"""
规则0912 筛选 —— 20cm（科创板 688 + 创业板 300/301）
...
RULE_NAME = "0912"
OUTPUT_DIR = Path(r"D:\09work\0912_backtest")
...
def screen_one(code, day_file, start_int, end_int):
    ...
    # 有效 i：i-4>=19 → i>=23；T+0~T+6 不足由 generate_t_fields 返回 N/A
    cand[:23] = False
